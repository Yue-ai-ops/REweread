...
assert(qml.includes('property string magicReplyDraft') && qml.includes('id: magicReplyInk')
  && qml.includes('magicReplyInk.begin(root.magicReplyDraft'), 'Magic Book replies must use the native pen-path writer instead of animated QML Text');
...
assert(qml.includes('y: root.magicNotebookAnswerTop') && qml.includes('magicReplyTilt')
